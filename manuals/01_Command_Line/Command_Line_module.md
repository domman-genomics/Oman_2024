...
process and analyze this data. One advantage of learning Unix is that many of the
...
- Linux is pretty straightforward, but there are some general points to remember that will make your life easier:
     ...
     - You need to put a space between a command and its argument - for example, `more myfile` will show you the contents of the file called `myfile`; whereas `moremyfile` will just give you an error!
...
This module was adapted from the Wellcome Connecting Science course "Working with Pathogen Genomes"  
https://github.com/WCSCourses/WWPG_2022
